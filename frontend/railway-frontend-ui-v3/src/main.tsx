...
function Overview({connected,onRequests,onRecommended}:{connected:boolean;onRequests:()=>void;onRecommended:()=>void}) {
  ...
  return <>
    <div className="context">
      <div><span className="eyebrow">OPERATIONAL SECTION</span><div className="sectionValue">S02: Ghaziabad → Tundla <ChevronDown size={15}/></div><p><Clock3 size={12}/> Horizon: 24h (Today)</p></div>
